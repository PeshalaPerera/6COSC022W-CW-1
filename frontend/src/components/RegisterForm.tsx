...
const RegisterForm = ({ switchView }: { switchView: (view: string) => void }) => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} style={styles.form}>
      ...
      <div style={styles.inputWrapper}>
        ...
        <input name="email" placeholder="E-mail" onChange={handleChange} required style={styles.input} />
      </div>
      <div style={styles.inputWrapper}>
    ...
    <p style={styles.switchText}>
      ...
      <span onClick={() => switchView("login")} style={{ color: "#007bff", cursor: "pointer", textDecoration: "underline" }}>
        Login here
      </span>
    </p>
  </div>
...
const styles = {
  ...
  cardTitle: { fontSize: '1.5rem', fontWeight: 'bold', color: '#333', marginBottom: '1.5rem' },
  ...
  input: { flex: 1, border: 'none', background: 'transparent', outline: 'none', fontSize: '1rem' },
  button: {
    padding: '0.75rem',
